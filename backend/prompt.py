...
def calories(photo_files):
    ...
    5. Правила расчёта воды:
       ...
       • Для чистой воды весь объём считается водой.
       • Для напитков учитывай фактическое содержание воды.
       • Для фруктов, овощей, ягод, супов и других продуктов оцени содержание воды по средним пищевым значениям.
       • Для сухих продуктов (хлеб, печенье, орехи и т.п.) содержание воды обычно низкое.
       • Вода должна быть реалистичной и соответствовать продукту.

    6. Если на фото нет еды, напитков или съедобных продуктов (например: человек, документ, улица, мебель, животное и т.д.) — верни только:
    ...
    • "water_intake" — суммарное количество воды из всех продуктов в литрах.
    • Сумма значений "вода" всех элементов массива detail должна быть равна "water_intake".
