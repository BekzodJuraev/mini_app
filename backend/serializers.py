...
class ProfileSer(serializers.ModelSerializer):
    ...
    class Meta:
        model=Profile
        fields=['name','lastname','middle_name','gender','age','photo','avatar_image', 'avatar_CARDIOVASCULAR','avatar_DIGESTIVE','avatar_ENDOCRINE','avatar_MUSCULOSKELETAL','avatar_RESPIRATORY','avatar_REPRODUCTIVE','life_expectancy','balance','IK','place_of_residence','date_birth','pressure_test','life_expectancy_json','health_recommendations','risk_test','pressure_plus','diary_plus','analysis_risk']
...
class NotificationPEtSer(serializers.ModelSerializer):
    class Meta:
        model=Tests_Pet
        fields=['id','name','created_at','read',]
...
class ChatGETSerQuestion(serializers.ModelSerializer):
    class Meta:
        model=Chat
...
class GetRelationship(serializers.ModelSerializer):
    ...
    percentage_food = serializers.IntegerField(source='food_percentage')
...
class PetSerGet(serializers.ModelSerializer):
    ...
    percentage=serializers.IntegerField(source='food_percentage')
    tests_count = serializers.IntegerField()
